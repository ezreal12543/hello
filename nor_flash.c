...
void nor_flash_test(void)
{
	...
	while (1)
	{
		...
		switch (c)		 
		{
			...
			case 's':
			case 'S':
				intbuff = INTMSK;INTMSK = 0xFFFFFFFF;do_scan_nor_flash();INTMSK = intbuff;
				break;
			...
			case 'r':
			case 'R':
				intbuff = INTMSK;INTMSK = 0xFFFFFFFF;do_read_nor_flash();INTMSK = intbuff;
				break;
			default:
				break;
		}
